...
Current BOCPD research authority is restricted to Adaptive Hazard V5 plus the frozen R2 benchmark and the explicit code/result/workflow allowlist in Section 3.1; all other BOCPD model surfaces are superseded and removed from the active research surface.
