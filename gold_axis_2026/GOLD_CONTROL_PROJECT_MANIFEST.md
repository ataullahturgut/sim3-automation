...
- fail-closed exact-date probe implementation/tests: `dc38d86b229d3f5a2c9f732ce64f7d0`;
...
- Baur, D.G., Beckmann, J., Czudaj, R. (gold forecasting with dynamic model averaging, *International Review of Financial Analysis*). Used as supporting gold-specific evidence that predictor relevance/model uncertainty is time varying; exact implementation parity with Gold Control is not assumed.
- Chen/Yang/Lan (2026), *Economics Letters*, gold IDMA study, PII `S0165176526003435`. Supports horizon-dependent gold drivers and adaptive model/predictor weighting; Gold Control's CORE5 implementation is not claimed to be an exact replication.
...
- 2026 *International Journal of Forecasting* factor-adjusted regularized forecast-combination research, PII `S0169207026000828`. This is a **conditional candidate family**, relevant only if the complementarity audit demonstrates a strong common-factor/high-correlation problem.
- 2026 *Economic Modelling* iterated forecast-combination research, PII `S0264999326003299`. This is a **conditional candidate family**, relevant only if the audit demonstrates complementary but time-unstable model edge and benchmark anchoring is justified.
- 2026 *Financial Innovation* daily asset-return ML study, DOI `10.1186/s40854-026-00927-8`, and 2023 *Chaos, Solitons & Fractals* gold ML study, PII `S0960077923009803`. These support regularized/tree-based data-rich short-horizon challengers; they do not prove Gold Control performance without the Section 19 nested PIT-safe test.
