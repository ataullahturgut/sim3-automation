...
def select_hybrid(method,Xraw,Yraw,split,target):
    ...
    # Map the validation-selected premise from inner-train standardized units
    # to full-history standardized units without any second validation-free meta search.
...
def run(method):
    ...
    out={"model_id":f"VW_MIDAS_{method}_ANFIS_HYBRID_V1","method":method,
      "hybrid_contract":{"metaheuristic":method,"meta_scope":"premise_centers_and_log_spreads","candidate_consequents":"OLS",
       "post_meta_local_learning":"Jang1993_normalized_gradient_plus_LSE_on_all_pre_target_history","local_epoch_selection":"chronological_inner_check_only",
