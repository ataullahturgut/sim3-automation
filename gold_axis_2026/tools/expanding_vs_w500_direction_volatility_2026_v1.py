...
def main():
    ...
    def evaluate(name,pol):
        ...
        return {
          ...
          "ledger":ledger}
    result={"identity":"GOLD_CONTROL_2026_EXPANDING_VS_W500_DIRECTION_VOLATILITY_DIAGNOSTIC_V1",
    ...
    out=args.out/"GOLD_CONTROL_2026_EXPANDING_VS_W500_DIRECTION_VOLATILITY_DIAGNOSTIC_V1_RESULT_2026-09-24.json"
