...
def main():
    ...
    jan30=[]
    for s in saug:
        if s["target_date"] not in ("2026-01-29","2026-01-30","2026-02-02"): continue
        rr=rmap[(s["origin_date"],s["target_date"])]
    ...
    result={"identity":"GOLD_CONTROL_2026_JAN30_FULL_CASCADE_STRESS_V1",
      "up2_2026_metrics":m26,"residual26_n":len(residual26),"jan30_window":jan30,
      "governance":{"stress_only":True,"retuning":False,"selection":False,"production_writes":False}}
    (args.out/"GOLD_CONTROL_2026_JAN30_FULL_CASCADE_STRESS_V1_RESULT_2026-09-24.json").write_text(json.dumps(result,indent=2),encoding="utf-8")
